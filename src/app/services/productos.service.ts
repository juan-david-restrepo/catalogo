...
import { CategoriaModel, Producto, CatalogoResponse } from '../models/producto.model';
...
export class ProductosService {
  ...
  /** Obtiene catálogo completo con paginación e imágenes optimizadas */
  getCatalogo(page: number = 1, limit: number = 24): Observable<CatalogoResponse> {
    return this.http.get<CatalogoResponse>(`${this.api}/catalogo?page=${page}&limit=${limit}`);
  }
